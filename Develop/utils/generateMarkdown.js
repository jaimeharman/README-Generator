...
function badgeMaker(license) {
  ...
  switch (license) {
    ...
    case 'BSD 2-Clause "Simplified" License':
      badgeImg = 'https://img.shields.io/badge/License-BSD%202--Clause-orange.svg'
      badgeURL = 'https://opensource.org/licenses/BSD-2-Clause'
      break;
    case 'BSD 3-Clause "New" or "Revised" License':
      badgeImg = 'https://img.shields.io/badge/License-BSD%203--Clause-blue.svg'
      badgeURL = 'https://opensource.org/licenses/BSD-3-Clause'
      break;
    case "Boost Software License 1.0":
      badgeImg = 'https://img.shields.io/badge/License-Boost%201.0-lightblue.svg'
    ...
    case "Mozilla Public License 2.0":
      badgeImg = 'https://img.shields.io/badge/License-MPL%202.0-brightgreen.svg'
